...
export default function CreateForm({ categorias, unidadesBase, onClose }) {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('almacen-central.productos.store'), {
            onSuccess: () => {
                reset();
                onClose();
            },
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                    ...
                    <Input
                        ...
                        error={errors.nombre}
                        placeholder="Ketchup Heinz, Aceite Primor..."
                    />
                </div>
                ...
                {data.unidades_medida.length > 0 ? (
                    ...
                    <div className="rounded-lg border-2 border-dashed border-gray-300 p-8 text-center">
                        <p className="text-sm text-gray-500">
                            No hay unidades agregadas. Agrega al menos una unidad de medida.
                        </p>
                    </div>
                )}
            </div>

            {errors.unidades_medida && (
                <p className="text-sm text-red-600">{errors.unidades_medida}</p>
            )}
